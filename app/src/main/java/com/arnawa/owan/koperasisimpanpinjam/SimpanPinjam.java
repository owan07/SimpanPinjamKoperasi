...
public class SimpanPinjam extends AppCompatActivity implements ExpandableListView.OnGroupClickListener, ExpandableListView.OnChildClickListener{
    ...
    private void setListData() {
        ...
        listParentSidebar.add(Constant.S_SIMPANPINJAM_LOGOUT, "Keluar");

        // Adding child data
        PinjamanChild = new ArrayList<String>();
        PinjamanChild.add("Data Pengajuan Pinjaman");
        PinjamanChild.add("Pengajuan Pinjaman Baru");
        ...
        listChildSidebar.put(listParentSidebar.get(Constant.S_SIMPANPINJAM_LOGOUT)    , new ArrayList<String>());
    }
    ...
    public boolean onGroupClick(ExpandableListView parent,View v,int groupPosition,long id) {
        ...
        switch (groupPosition){
            ...
            case Constant.S_SIMPANPINJAM_LOGOUT:
                AlertDialog.Builder builderout = new AlertDialog.Builder(this);
                builderout.setCancelable(false);
                builderout.setMessage("Anda yakin ingin mengeluarkan akun Anda?");
                ...
                builderout.setNegativeButton("Tidak", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
                    }
                });
                AlertDialog alert = builderout.create();
                alert.show();
                break;
