...
public class arwanaapiutils {
    ...
    public static final String data_jenis_simpanan= "http://ksupegangsaanmobile.kuperasi.com/loginmobile/jenis_simpanan";
    ...
    public static final String data_anggota_sp = "http://ksupegangsaanmobile.kuperasi.com/loginmobile/nama_anggota_simpanan";
    ...
    public static JSONObject dataanggotasp(String id) throws ClientProtocolException, IOException {
        ...
        nameValuePairs.add(new BasicNameValuePair("q",
                id));
        return
                httpPostToApi(data_anggota_sp, nameValuePairs);
    }
    ...
    public static JSONObject datajenissimpanan(String id) throws ClientProtocolException, IOException {
        // Add the order data//uid=demo&pwd=demo
        List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(
                1);
        nameValuePairs.add(new BasicNameValuePair("q",
                id));
        return
                httpPostToApi(data_jenis_simpanan, nameValuePairs);
    }

    public static JSONObject datatambahsimpanan(String nama, String tgl, String jml, String jenis, String ket) throws ClientProtocolException, IOException {
        // Add the order data//uid=demo&pwd=demo
        List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(
                1);
        nameValuePairs.add(new BasicNameValuePair("anggota_id",
                nama));
        nameValuePairs.add(new BasicNameValuePair("tgl_transaksi",
                tgl));
        nameValuePairs.add(new BasicNameValuePair("jumlah",
                jml));
        nameValuePairs.add(new BasicNameValuePair("jenis_id",
                jenis));
